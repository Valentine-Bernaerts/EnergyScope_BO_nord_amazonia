...
# but calls solve_esom(iis_diagnostic=True) instead of the normal solve_esom().
...
reality_ampl_options = {
    'show_stats': 3,
    'log_file': str(my_model.cs_dir / 'log_iis_diagnostic.txt'),
    'presolve': 200,
    'times': 1,
    'gentimes': 1,
...
my_model.solve_esom(iis_diagnostic=True)
