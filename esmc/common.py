...
named_space_id = {'AT_BE_BG_CH_CZ_DE_DK_EE_ES_FI_FR_GB_GR_HR_HU_IE_IT_LT_LU_LV_NL_PL_PT_RO_SE_SI_SK': 'eu27',
                  ...
                  'BN_BN-IT_BN-YC_CB_CH_LP_OR_PA-NA_PT_SC_SC-AS_SC-CC_SC-CQ_SC-GB_SC-MI_SC-VC_SC-VL_TJ_TJ-BE_TJ-OC': 'bo'}
...
bo_country_code = ['SIN', 'SA-BN', 'SA-PA', 'SA-TJ', 'SA-SC', 'HL', 'LL', 'VL']
bo_full_names = ['Sistema Interconectado Nacional', 'Sistemas Aislados Beni', 'Sistemas Aislados Pando', 'Sistemas Aislados Tarija', 'Sistemas Aislados Santa Cruz', 'Highlands', 'Lowlands', 'Valleys']
...
plotting_names = {
    ...
    "PHS": "PHS",
    "BATT_LI": "Li-ion batt.",
    "BATT_HS": "li-ion HomeSystem batt.",
    "BEV_BATT": "BEV batt.",
    "PHEV_BATT": "PHEV batt.",
